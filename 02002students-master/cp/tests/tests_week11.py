...
class Week11AverageGrowthCurve(UTestCase):
    ...
    def test_get_std(self):
        ...
        self.assertArrayAlmostEqual(get_std(data),
                                    np.array([0.7781667, 0.3194126, 0.2433594, 0.2044697, 0.1797871, 0.1623305]))
    ...
    def test_get_mean(self):
        ...
        data = np.sqrt(np.arange(42)).reshape(6, 7).T
        self.assertArrayAlmostEqual(get_mean(data),
                                    np.array([1.5474032, 3.1461048, 4.1159174, 4.8947106, 5.5648609, 6.1622763]))
